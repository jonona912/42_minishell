...
/*   Updated: 2025/05/07 18:53:31 by opopov           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_tokenize_loop_part1(
					char *line, int *i, t_tokenize_struct *vars, t_token_lst **token_lst);
int				is_not_special_char(char c);
t_token_type	return_token_type(char *str);
int				send_str_to_token_lst(
					char *str, t_token_lst **token_lst, t_token_type token_type);
int				copy_until_special_char(
					char *current_token, char *line, char *char_set);
...
int				handle_other_tokens(char *line,
					t_token_lst **token_lst, t_tokenize_struct *vars);
...
int				copy_token_till_delimiter(char **dest,
					char *src, char delimiter, t_token_lst **token_lst);
...
int				copy_quotes_if(char *current_token, char *line, char **final_word, t_shell *shell);
